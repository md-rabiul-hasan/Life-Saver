...
(function ($) {
    ...
    var singleQualificationArea = document.getElementById("qualification-area");
	var ourButton = document.getElementById("add-field-btn");

	ourButton.addEventListener("click", createNewItem);

	function createNewItem() {
		singleQualificationArea.innerHTML += newItemCounter;
	}
