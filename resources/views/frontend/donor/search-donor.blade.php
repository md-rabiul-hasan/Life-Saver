...
<div class="hero-area overlay" style="background-image: url(https://geniusocean.com/demo/bloodbank/assets/images/1520177825home-top-min.jpg);">
    <div class="container">
       <div class="row">
          <div class="col-md-12">
             ...
             <h1 class="donors-header text-center">{{ count($alllSearchDonor) }} Donors Found</h1>
             <div class="hero-form">
                      ...
                      <div class="row">
                               ...
                               <div class="input-group">
                                  ...
                                  <select name="district_id" class="form-control" id="">
                                    ...
                                    @foreach($allDistrict as $singleDistrict)
                                      <option value="{{ $singleDistrict->id }}"
                                        @php
                                            if($singleDistrict->id == $district_id){
                                                echo "selected";
                                            }
                                        @endphp
                                        >{{ $singleDistrict->name }}</option>
                                    @endforeach
                                 </select>
                               </div>
                            </div>
                         ...
                         <select name="group" id="blood_grp" class="form-control" required>
                            ...
                            @foreach($allBloodGroup as $singleBloodGroup)
                              <option   value="{{ $singleBloodGroup->id }}"
                                @php
                                    if($singleBloodGroup->id == $bloodGroup){
                                        echo "selected";
                                    }
                                @endphp
                                >{{ $singleBloodGroup->name }}</option>
                            @endforeach                      
                            </select>
                         </div>
                         </div>
 ...
 <div class="section-padding all-donors-wrap team_section team_style2 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
    <div class="container">
       <div class="row">
           @foreach($alllSearchDonor as $singleSearchDonor)
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="team_common">
                    <div class="member_img">
                    <a href="https://geniusocean.com/demo/bloodbank/donor-profile/123">
                        <img src="{{ $singleSearchDonor->avatar }}" alt="member image">
                    </a>
                    </div>
                    ...
                    <div class="content">
                        <a href="https://geniusocean.com/demo/bloodbank/donor-profile/123" class="d_inline fw_600">{{ $singleSearchDonor->user->name }}</a>
                        <span class="d_block transition_3s">Blood Group: {{ $singleSearchDonor->bloodGroup->name }}</span>
